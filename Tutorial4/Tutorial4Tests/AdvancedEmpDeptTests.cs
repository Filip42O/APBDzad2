...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = (from emp in emps where emp.DeptNo.Equals(30) select emp.Sal).Min(); 
    ...
    public void ShouldReturnEmployeesWithManagers()
    {
        ...
        var withMgr = (from emp in emps where emp.Mgr is not null select emp);
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = from Employee in emps join Manager in emps on Employee.Mgr equals Manager.EmpNo
